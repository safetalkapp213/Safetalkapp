        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-12">
          {steps.map((step, index) => (
            <div key={index} className="flex-1 flex flex-col items-center text-center relative group">
              ...
              {/* Step Circle */}
              <div className="rounded-full bg-gradient-to-r from-teal-600 to-orange-500 text-white w-16 h-16 flex items-center justify-center mb-4 text-2xl font-bold shadow-lg transition-transform duration-300 group-hover:scale-110 z-10">
                {step.number}
              </div>
